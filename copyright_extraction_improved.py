#!/usr/bin/env python3
"""
Copyright Extraction Tool - Improved Version
Extracts copyright and license information from source code directories.

Phase 1 Improvements:
- Case-insensitive copyright matching (©, (c), Copyright, etc.)
- File extension filtering (text files only)
...
class CopyrightExtractionGUI:
    """Improved GUI for copyright extraction."""
